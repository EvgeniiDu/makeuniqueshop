        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 d-flex" style="justify-content: space-between">
                    <h1 class="m-0">Редагування товару</h1>
                    <button class="btn btn-success">
                        <a href="{{route('admin.products')}}" style="text-decoration: none; color: #f2f4f5">Всі товари</a>
                    </button>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <form wire:submit.prevent="updateProduct">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input class="form-control  @error('image') is-invalid @enderror" type="file" id="feature_image"
                               name="image" accept="image/png, image/gif, image/jpeg" value="" wire:model="newImage">
                        @if($newImage)
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('height') is-invalid @enderror"
                               id="exampleInputEmail1" placeholder="Введіть висоту"
                               wire:model="height">
                        @error('height')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('length') is-invalid @enderror"
                               id="exampleInputEmail1" placeholder="Введіть довжину"
                               wire:model="length">
                        @error('length')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('width') is-invalid @enderror"
                               id="exampleInputEmail1" placeholder="Введіть ширину"
                               wire:model="width">
                    </div>
                </div>
                @if($category_id == 4)
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                   placeholder="Введіть наповнення матрасу"
                                   wire:model="filling">
                        </div>
                    </div>
                @endif
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('coating') is-invalid @enderror"
                               id="exampleInputEmail1"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('images') is-invalid @enderror" type="file" id="feature_image"
                               accept="image/png, image/gif, image/jpeg" wire:model="images" multiple>
                        <div wire:loading wire:target="images">Uploading...</div>
                        <div class="mt-3 d-flex">
                            @foreach($images as $image_old)
                                <div class="mr-3 ">
                                    <img src="{{$image_old->temporaryUrl()}}" alt=""
                                         width="120">
                                </div>
                            @endforeach
                            @foreach($productImages as $image)
                                <div class="mr-3 ">
                                    <img src="{{asset('assets/images/products')}}/{{$image->path}}" alt=""
                                         width="120">
                                    <a href="" wire:click.prevent="deleteImage({{ $image->id }})"><i
                        ...
                        @if(Session::has('success_message'))
                            <div class="alert alert-success mt-4" style="width: 300px">
                ...
                <div class="card-footer">
                    <button wire:click.prevent="updateProduct" class="btn btn-primary">Оновити</button>
                </div>
            </form>
        </div>
    </section>

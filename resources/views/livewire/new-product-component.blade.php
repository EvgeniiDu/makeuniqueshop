...
<div>
    ...
    <div class="payshipping_main_container">
        <div class="left_box">
            <div class="left_content_container">
                ...
                <ul>
                    <li><a href="{{route('hotsales')}}">Гарячі
                            знижки</a></li>
                    <li><a href="{{route('top')}}">Топ продажу</a></li>
                    <li><a href="{{route('new')}}"  style="text-decoration: underline; font-weight: 500;">Новинки</a></li>
                </ul>
                <ul>
    ...
    <div class="paginate_line_container">
        {{ $products_new->withQueryString()->links('pagination-links') }}
    </div>
</div>

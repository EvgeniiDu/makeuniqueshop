...
<div>
        ...
        <div class="left_box">
            <div class="left_content_container">
                ...
                <ul>
                    ...
                    <li><a href="{{route('top')}}" style="text-decoration: underline; font-weight: 500;">Топ продажу</a>
                    </li>
                    ...
                    <div class="descrip_product">
                        ...
                        <div class="info_div_box">
                            ...
                            <div class="info_div">
                                ...
                                <span class="info_span" id="cover">{{ $product->coating }}</span>
                            </div>
                            <div class="info_div">
    ...
    <div class="paginate_line_container">
        {{ $products_top->withQueryString()->links('pagination-links') }}
    </div>
</div>
